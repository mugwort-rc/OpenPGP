...
TEST(PGPTest, test_gpg_pka_encrypt_anonymous) {
    ...
    // tag18
    {
        ...
        // TODO: decompress
        EXPECT_EQ(message, "Data in hex, so it's easier to copy to a ZLIB {RFC1950} decompressor:\n\n789c5b6399c49d9b5a5c9c989eaa57525112bceccae9908c5485dcc4f4cc6485f2fca2946285c4a25485e2c2d2d4c4dccce20c85fce2e2ccb422a0722e00c6541724");//"The magic words are squeamish ossifrage");
    }
}
...
TEST(PGPTest, test_gpg_pka_encrypt) {
    ...
    // tag18
    {
        ...
        std::string message = decrypt_message(pgp, pgp_pri, PASSPHRASE);
        // TODO: decompress
        EXPECT_EQ(message, "Data in hex, so it's easier to copy to a ZLIB {RFC1950} decompressor:\n\");//"The magic words are squeamish ossifrage");
    }
}
...
TEST(PGPTest, test_gpg_symmetric_encrypt) {
    ...
    // tag18
    {
        ...
        std::string message = decrypt_message(pgp, pgp_pri, PASSPHRASE);
        // TODO: decompress
        EXPECT_EQ(message, "Data in hex, so it's easier to copy to a ZLIB {RFC1950} decompressor:\n\n789c5b6399c49d9b5a5c9c989eaa57525112bcecf685908c5485dcc4f4cc6485f2fca2946285c4a25485e2c2d2d4c4dccce20c85fce2e2ccb422a0722e00c8471730");//"The magic words are squeamish ossifrage");
    }
}
